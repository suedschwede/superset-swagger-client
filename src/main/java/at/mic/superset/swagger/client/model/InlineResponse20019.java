...
import at.mic.superset.swagger.client.model.QueryRestApiGetList;
...
public class InlineResponse20019 {
  ...
  private List<QueryRestApiGetList> result = null;

  public InlineResponse20019 count(BigDecimal count) {
    this.count = count;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse20019 descriptionColumns(InlineResponse200DescriptionColumns descriptionColumns) {
  ...
  **/
  ...
  public InlineResponse20019 ids(List<String> ids) {
    this.ids = ids;
    return this;
  }

  public InlineResponse20019 addIdsItem(String idsItem) {
    if (this.ids == null) {
  ...
  **/
  ...
  public InlineResponse20019 labelColumns(InlineResponse200LabelColumns labelColumns) {
  ...
  **/
  ...
  public InlineResponse20019 listColumns(List<String> listColumns) {
    this.listColumns = listColumns;
    return this;
  }

  public InlineResponse20019 addListColumnsItem(String listColumnsItem) {
  ...
  **/
  ...
  public InlineResponse20019 listTitle(String listTitle) {
  ...
  **/
  ...
  public InlineResponse20019 orderColumns(List<String> orderColumns) {
    this.orderColumns = orderColumns;
    return this;
  }

  public InlineResponse20019 addOrderColumnsItem(String orderColumnsItem) {
  ...
  **/
  ...
  public InlineResponse20019 result(List<QueryRestApiGetList> result) {
    this.result = result;
    return this;
  }

  public InlineResponse20019 addResultItem(QueryRestApiGetList resultItem) {
    if (this.result == null) {
      this.result = new ArrayList<QueryRestApiGetList>();
    }
  ...
  **/
  ...
  public List<QueryRestApiGetList> getResult() {
    return result;
  }

  public void setResult(List<QueryRestApiGetList> result) {
    this.result = result;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.count, inlineResponse20019.count) &&
        Objects.equals(this.descriptionColumns, inlineResponse20019.descriptionColumns) &&
        Objects.equals(this.ids, inlineResponse20019.ids) &&
        Objects.equals(this.labelColumns, inlineResponse20019.labelColumns) &&
        Objects.equals(this.listColumns, inlineResponse20019.listColumns) &&
        Objects.equals(this.listTitle, inlineResponse20019.listTitle) &&
        Objects.equals(this.orderColumns, inlineResponse20019.orderColumns) &&
