...
package at.mic.superset.swagger;
        ...
        GsonFireBuilder fireBuilder = new GsonFireBuilder()
          .registerTypeSelector(ChartDataPostProcessingOperation.class, new TypeSelector<ChartDataPostProcessingOperation>() {
            ...
            public Class<? extends ChartDataPostProcessingOperation> getClassForElement(JsonElement readElement) {
                Map<String, Class<? extends ChartDataPostProcessingOperation>> classByDiscriminatorValue = new HashMap<>();
                    classByDiscriminatorValue.put("AllOfChartDataQueryObjectPostProcessingItems".toUpperCase(), AllOfChartDataQueryObjectPostProcessingItems.class);
                    classByDiscriminatorValue.put("ChartDataPostProcessingOperation".toUpperCase(), ChartDataPostProcessingOperation.class);
                return getClassByDiscriminator(
                            classByDiscriminatorValue,
                            getDiscriminatorValue(readElement, ""));
            }
          })
          .registerPostProcessor(ChartDataPostProcessingOperation.class, new PostProcessor<ChartDataPostProcessingOperation>() {
              @Override
              public void postDeserialize(ChartDataPostProcessingOperation result, JsonElement src, Gson gson) {

              }

              @Override
              public void postSerialize(JsonElement result, ChartDataPostProcessingOperation src, Gson gson) {
